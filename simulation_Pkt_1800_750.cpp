 ...
 ***************************************************************************/
 ...
 void Simulation::MySimulation (const string &param_file){
	...
	//zrodlo punktowe w pkt 1780,730
	//double val = 3.345; //14 m3/s dx=10

	//zrodlo punktowe w pkt 1790,740
	//double val = 3.5905; //14 m3/s dx=10

	//zrodlo punktowe w pkt 1800,750
	double val = 3.8033; //14 m3/s dx=10
...
//ostat siatak
	...
	//zrodlo punktowe w pkt 1800,750
	double x0 = 1800/param.get_dx(), y0 = 750/param.get_dy();//dla Wisly - ekspertyza 
