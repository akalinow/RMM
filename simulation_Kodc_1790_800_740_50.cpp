 ...
 ***************************************************************************/
 ...
 void Simulation::MySimulation (const string &param_file){
	...
	//krotki odcinek 14 m miedzy punktami: 1780,730 i 1790,740
	//double val = 2.1978; //(14/2) m3/s dx=10, wartosc w pkt 1780,730

	//krotki odcinek 14 m miedzy punktami: 1790,740 i 1800,750
	double val = 2.4145; //(14/2) m3/s dx=10, wartosc w pkt 1790,740
...
//ostat siatak
	...
	//krotki odcinek 14 m miedzy punktami: 1780,730 i 1790,740
	//double x0 = 1780/param.get_dx(), y0 = 730/param.get_dy();//dla Wisly - ekspertyza 

	//krotki odcinek 14 m miedzy punktami: 1790,740 i 1800,750
	double x0 = 1790/param.get_dx(), y0 = 740/param.get_dy();//dla Wisly - ekspertyza 
	...
	//krotki odcinek 14 m miedzy punktami: 1780,730 i 1790,740
	//x0 = 1790/param.get_dx(), y0 = 740/param.get_dy();//dla Wisly - ekspertyza 
	//val = 2.4145;

	//krotki odcinek 14 m miedzy punktami: 1790,740 i 1800,750
	x0 = 1800/param.get_dx(), y0 = 750/param.get_dy();//dla Wisly - ekspertyza 
	val = 2.6109;
